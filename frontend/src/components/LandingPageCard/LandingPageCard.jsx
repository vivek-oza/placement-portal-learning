...
function LandingPageCard({ cardDetails }) {
  ...
  return (
    <>
      <div className="landingPageCard shadow-lg bg-white border-2 border-solid border-black rounded-lg m-2 p-4 flex flex-col flex-wrap justify-between gap-2 max-w-lg">
